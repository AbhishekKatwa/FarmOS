...
class ProductionValidationTest {
    private fun record(opening: Int = 10, mortality: Int = 0, culls: Int = 0, eggs: Int = 0, feed: Double = 0.0) = DailyProduction(
        farmId = "farm", shedId = "shed", flockId = "flock", date = "2026-08-27", openingLiveBirds = opening, mortality = mortality, culls = culls,
        eggsCollected = eggs, brokenEggs = 0, dirtyEggs = 0, usableEggs = 0, rejectedEggs = 0, feedConsumedKg = feed
    )
