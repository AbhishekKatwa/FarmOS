...
class FeedCalculatorTest {
 @Test fun stockIsDerivedFromLedgerMovements(){val item=FeedItem(id="i",farmId="f",name="Layer",feedType=FeedType.LAYER_FEED,openingQuantityKg=10.0,openingCostPerKg=20.0);val stock=FeedCalculator.stock(item,listOf(FeedPurchase(localId="p1",feedItemId="i",farmId="f",supplier="s",quantityKg=20.0,unit="kg",pricePerKg=25.0,batch="b",purchaseDate="2026-08-27")),listOf(FeedConsumption(localId="c1",feedItemId="i",farmId="f",quantityKg=8.0,consumedDate="2026-08-27")),listOf(FeedAdjustment(localId="a1",feedItemId="i",farmId="f",quantityKg=-2.0,adjustmentDate="2026-08-27",reason="spill")));assertEquals(20.0,stock.quantityKg,0.001);assertEquals(23.333,stock.averageCostPerKg!!,0.001)}
